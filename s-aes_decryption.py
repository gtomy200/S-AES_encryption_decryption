#Function creating the array of ciphertext
def arr(text):
    cipher_text_array = list()
    count = 0
    strg = ' '
    first_time = 'Y'
    for value in text:
...
#Function for inverse s-box    
def inverse_s_box(*a):
    dict_box = {'1001':'0000', '0100':'0001', '1010':'0010', '1011':'0011', '1101':'0100', '0001':'0101', '1000':'0110', '0101':'0111', '0110':'1000', '0010':'1001', '0000':'1010', '0011':'1011', '1100':'1100', '1110':'1101', '1111':'1110', '0111':'1111'}
...
#Function for the checking length of cipher text and key
...
#Round 0 function
def round0():
       temp_text = cipher_text_array[2]
       cipher_text_array[2] = cipher_text_array[1]
       cipher_text_array[1] = temp_text
       state_matrix = matrix_operation(cipher_text_array,key2)
       
       return (state_matrix)
    
#Round 1 function
def round1():
    temp_text = round0_output[2]
    round0_output[2] = round0_output[3]
    round0_output[3] = temp_text
    state_matrix = inverse_s_box(round0_output[0], round0_output[1], round0_output[2], round0_output[3])
...
#Round 2 function
def round2():
    temp_text = round1_output[2]
    round1_output[2] = round1_output[3]
    round1_output[3] = temp_text
    state_matrix = inverse_s_box(round1_output[0], round1_output[1], round1_output[2], round1_output[3])
    state_matrix = matrix_operation(state_matrix,key)
...
def inverse_mix_column (temp_matrix):
    state_matrix = list()
...
#Cipher text input     
cipher_text = input('Enter the binary cipher_text: ')

#Checking the input length
length,strg = chk_length(cipher_text)
if length != 16:
    print ('Enter a valid ciphertext of length  16 bits')
    quit()
...
cipher_text_array = arr(cipher_text)
...
#Output Ciphertext
print('The plaintext is: '+ round2_output[0]+' ' + round2_output[2]+' '+ round2_output[1]+' '+round2_output[3])
